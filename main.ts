...
const profesor1: Profesor = new Profesor("Ana", "García", "P123456", "Soltera", 2015, "D201", "Arquitectura");
const estudiante1: Estudiante = new Estudiante("Juan", "Pérez", "E987654", "Casado", "3º Ingeniería");
const servicio1: PersonalServicio = new PersonalServicio("Carlos", "Ruiz", "S543210", "Divorciado", 2020, "D005", "Biblioteca");
